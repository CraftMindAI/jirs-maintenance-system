...
export default function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative h-[160vh] bg-[#050b14] select-none dot-pattern">
      {/* STICKY VIEWPORT */}
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden pt-8">
        ...
        <div className="relative z-10 w-full px-4 md:px-8 max-w-7xl mx-auto text-white py-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.08] tracking-tight">
                Precision Campus <br />
              ...
              <p className="font-body-lg text-base sm:text-lg text-slate-300 max-w-xl leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link 
                  href="/login" 
                  className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-2xl font-extrabold text-sm transition-all flex items-center gap-2 shadow-xl shadow-primary/30 hover:scale-105 active:scale-95 cursor-pointer"
                >
                  Raise Complaint <Icon name="arrow_forward" className="text-base" />
                </Link>
                <Link 
                  href="/login" 
                  className="bg-white/10 hover:bg-white/15 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-2xl font-extrabold text-sm transition-all hover:scale-105 active:scale-95 cursor-pointer"
                >
                  View Ticket Status
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-white/10 max-w-lg">
                <div>
                  ...
                  <div className="text-[11px] text-slate-400 mt-1 uppercase tracking-wider font-mono">3-Day SLA Target</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-black text-white">4.9★</div>
                  <div className="text-[11px] text-slate-400 mt-1 uppercase tracking-wider font-mono">Campus Rating</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-black text-white">15 Min</div>
                  <div className="text-[11px] text-slate-400 mt-1 uppercase tracking-wider font-mono">Avg Response</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 w-full relative flex justify-center">
              ...
              <div className="relative w-[340px] h-[340px] sm:w-[400px] sm:h-[400px] rounded-full bg-slate-900/90 backdrop-blur-2xl border-2 border-white/20 p-6 shadow-2xl flex items-center justify-center text-center overflow-hidden group hover:border-primary/50 transition-all">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 z-10 p-8 flex flex-col justify-between items-center text-center bg-gradient-to-br from-slate-900 via-[#0b1c30] to-slate-950 text-white rounded-full"
                >
                  

                  <div className="space-y-2 my-auto max-w-xs">
                    <p className="font-display text-base sm:text-lg font-bold leading-relaxed tracking-tight italic text-slate-100">
                ...
                {/* STATE 2: STATIC PORTAL IMAGE INSIDE CIRCLE (NO INTERNAL SCROLLING) */}
                <motion.div
