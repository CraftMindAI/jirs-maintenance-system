...
export default function AdminSettings() {
  ...
  // Profile states
  const [fullName, setFullName] = useState("Admin Principal");
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      setFullName(data.name || "Admin Principal");
    ...
    <div className="space-y-8 pb-12 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Update admin profile parameters and configure security credentials.
        </p>
      </div>
            ...
            <div className="space-y-6">
              {profileSaved && (
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 rounded-2xl text-sm font-bold flex items-center gap-3 animate-fade-in">
                  ...
                  Admin profile parameters updated!
                </div>
              )}
                ...
                <div className="flex gap-4 pt-6 border-t border-slate-100 dark:border-slate-800/40">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setEmail("admin@jirs.ac.in");
                      setPhone("+91 99001 99880");
