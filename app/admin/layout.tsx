...
const MENU_ITEMS: MenuItem[] = [
  ...
  { label: "Raise Complaint", icon: "add_circle", href: "/admin/raise-complaint" },
  { label: "View Complaints", icon: "assignment", href: "/admin/view-complaints" },
  { label: "Track Complaints", icon: "my_location", href: "/admin/track-complaints" },
        ...
        <header className="sticky top-0 z-30 h-16 flex items-center justify-between px-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-all">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 text-sm text-slate-400 font-semibold">
              <Link href="/admin" className="hover:text-primary dark:hover:text-white transition-colors">
                JMMS Admin
              </Link>
